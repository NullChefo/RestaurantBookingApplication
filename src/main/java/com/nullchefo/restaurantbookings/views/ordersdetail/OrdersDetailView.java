package com.nullchefo.restaurantbookings.views.ordersdetail;
...
@Route(value = "orders-detail/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@AnonymousAllowed
@Uses(Icon.class)
public class OrdersDetailView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "orders-detail/%s/edit";
    ...
    public OrdersDetailView(SamplePersonService samplePersonService) {
