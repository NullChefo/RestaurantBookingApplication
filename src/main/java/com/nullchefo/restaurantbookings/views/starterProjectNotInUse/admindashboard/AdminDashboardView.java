package com.nullchefo.restaurantbookings.views.starterProjectNotInUse.admindashboard;

import com.nullchefo.restaurantbookings.views.MainLayout;
import com.nullchefo.restaurantbookings.views.starterProjectNotInUse.admindashboard.ServiceHealth.Status;
...
@Route(value = "admin-dashboard-not", layout = MainLayout.class)
@RolesAllowed("ADMIN")
