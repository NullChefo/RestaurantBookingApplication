package com.nullchefo.restaurantbookings.views.starterProjectNotInUse.restaurantdashboard;

import com.nullchefo.restaurantbookings.views.MainLayout;
import com.nullchefo.restaurantbookings.views.starterProjectNotInUse.restaurantdashboard.ServiceHealth.Status;
...
@Route(value = "restaurant-dashboard-not", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class RestaurantDashboardView extends Main {

	public RestaurantDashboardView() {
		addClassName("restaurant-dashboard-view");
