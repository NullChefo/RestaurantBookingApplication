...
public class CookiesInfoView extends VerticalLayout {
	...
	public CookiesInfoView() {
		...
		typesSection.add(new Paragraph(
		...
		typesSection.add(new Paragraph(
				"2. Analytics Cookies: These cookies help us analyze and improve the performance of our website by collecting and reporting information on how users interact with the site."));
		typesSection.add(new Paragraph(
				"3. Marketing Cookies: These cookies are used to deliver personalized advertisements and content based on your interests and preferences."));
		...
		managingSection.add(new Paragraph(
				"You can manage or disable cookies in your browser settings. However, please note that disabling certain cookies may affect the functionality of the website."));

		// Additional Information
		Div additionalSection = createSection("Additional Information");
		additionalSection.add(new Paragraph(
				"For more details on how we use cookies and to review our full Cookie Policy, please refer to our dedicated Cookie Policy page."));
