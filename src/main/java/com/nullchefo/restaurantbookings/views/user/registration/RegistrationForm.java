...
public class RegistrationForm extends FormLayout {
	...
	private Checkbox registerAsOrganisation;
	...
	public RegistrationForm() {
		...
		registerAsOrganisation = new Checkbox("Register as organisation");
		allowMarketing.getStyle().set("margin-top", "10px");
		...
		add(title, firstName, lastName, email, password,
			passwordConfirm, allowMarketing, registerAsOrganisation, errorMessageField,
			submitButton);
